...
@overload
def pow(base: Tuple[glm_typing.Number], exponent: Tuple[glm_typing.Number], /) -> vec1: ...
@overload
def pow(base: Tuple[glm_typing.Number, glm_typing.Number], exponent: Tuple[glm_typing.Number, glm_typing.Number], /) -> vec2: ...
@overload
def pow(base: Tuple[glm_typing.Number, glm_typing.Number, glm_typing.Number], exponent: Tuple[glm_typing.Number, glm_typing.Number, glm_typing.Number], /) -> vec3: ...
@overload
def pow(base: Tuple[glm_typing.Number, glm_typing.Number, glm_typing.Number, glm_typing.Number], exponent: Tuple[glm_typing.Number, glm_typing.Number, glm_typing.Number, glm_typing.Number], /) -> vec4: ...
@overload
