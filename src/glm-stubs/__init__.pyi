...
_V1T = TypeVar('_V1T', bvec1, dvec1, i16vec1, i64vec1, i8vec1, ivec1, u16vec1, u64vec1, u8vec1, uvec1, vec1)
_V2T = TypeVar('_V2T', bvec2, dmvec2, dvec2, i16vec2, i64vec2, i8vec2, imvec2, ivec2, mvec2, u16vec2, u64vec2, u8vec2, umvec2, uvec2, vec2)
_V3T = TypeVar('_V3T', bvec3, dmvec3, dvec3, i16vec3, i64vec3, i8vec3, imvec3, ivec3, mvec3, u16vec3, u64vec3, u8vec3, umvec3, uvec3, vec3)
_V4T = TypeVar('_V4T', bvec4, dmvec4, dvec4, i16vec4, i64vec4, i8vec4, imvec4, ivec4, mvec4, u16vec4, u64vec4, u8vec4, umvec4, uvec4, vec4)
_M2X2T = TypeVar('_M2X2T', dmat2x2, imat2x2, mat2x2, umat2x2)
_M2X3T = TypeVar('_M2X3T', dmat2x3, imat2x3, mat2x3, umat2x3)
_M2X4T = TypeVar('_M2X4T', dmat2x4, imat2x4, mat2x4, umat2x4)
_M3X2T = TypeVar('_M3X2T', dmat3x2, imat3x2, mat3x2, umat3x2)
_M3X3T = TypeVar('_M3X3T', dmat3x3, imat3x3, mat3x3, umat3x3)
_M3X4T = TypeVar('_M3X4T', dmat3x4, imat3x4, mat3x4, umat3x4)
_M4X2T = TypeVar('_M4X2T', dmat4x2, imat4x2, mat4x2, umat4x2)
_M4X3T = TypeVar('_M4X3T', dmat4x3, imat4x3, mat4x3, umat4x3)
_M4X4T = TypeVar('_M4X4T', dmat4x4, imat4x4, mat4x4, umat4x4)
...
@overload
def mix(x: _V1T, y: _V1T, a: Union[glm_typing.FDAnyVector1, glm_typing.BAnyVector1, glm_typing.Number], /) -> _V1T: ...
@overload
def mix(x: _V2T, y: _V2T, a: Union[glm_typing.FDAnyVector2, glm_typing.BAnyVector2, glm_typing.Number], /) -> _V2T: ...
@overload
def mix(x: _V3T, y: _V3T, a: Union[glm_typing.FDAnyVector3, glm_typing.BAnyVector3, glm_typing.Number], /) -> _V3T: ...
@overload
def mix(x: _V4T, y: _V4T, a: Union[glm_typing.FDAnyVector4, glm_typing.BAnyVector4, glm_typing.Number], /) -> _V4T: ...
@overload
def mix(x: _M2X2T, y: _M2X2T, a: Union[glm_typing.FAnyMatrix2x2, glm_typing.Number], /) -> _M2X2T: ...
@overload
def mix(x: _M2X3T, y: _M2X3T, a: Union[glm_typing.FAnyMatrix2x3, glm_typing.Number], /) -> _M2X3T: ...
@overload
def mix(x: _M2X4T, y: _M2X4T, a: Union[glm_typing.FAnyMatrix2x4, glm_typing.Number], /) -> _M2X4T: ...
@overload
def mix(x: _M3X2T, y: _M3X2T, a: Union[glm_typing.FAnyMatrix3x2, glm_typing.Number], /) -> _M3X2T: ...
@overload
def mix(x: _M3X3T, y: _M3X3T, a: Union[glm_typing.FAnyMatrix3x3, glm_typing.Number], /) -> _M3X3T: ...
@overload
def mix(x: _M3X4T, y: _M3X4T, a: Union[glm_typing.FAnyMatrix3x4, glm_typing.Number], /) -> _M3X4T: ...
@overload
def mix(x: _M4X2T, y: _M4X2T, a: Union[glm_typing.FAnyMatrix4x2, glm_typing.Number], /) -> _M4X2T: ...
@overload
def mix(x: _M4X3T, y: _M4X3T, a: Union[glm_typing.FAnyMatrix4x3, glm_typing.Number], /) -> _M4X3T: ...
@overload
def mix(x: _M4X4T, y: _M4X4T, a: Union[glm_typing.FAnyMatrix4x4, glm_typing.Number], /) -> _M4X4T: ...
@overload
...
__all__ = ['abs', 'array', 'bool_', 'bvec1', 'bvec2', 'bvec3', 'bvec4', 'c_int16', 'c_int32', 'c_int64', 'c_int8', 'c_uint16', 'c_uint32', 'c_uint64', 'c_uint8', 'ceil', 'clamp', 'dmat2', 'dmat2x2', 'dmat2x3', 'dmat2x4', 'dmat3', 'dmat3x2', 'dmat3x3', 'dmat3x4', 'dmat4', 'dmat4x2', 'dmat4x3', 'dmat4x4', 'dmvec2', 'dmvec3', 'dmvec4', 'double', 'dquat', 'dvec1', 'dvec2', 'dvec3', 'dvec4', 'f32mat2', 'f32mat2x2', 'f32mat2x3', 'f32mat2x4', 'f32mat3', 'f32mat3x2', 'f32mat3x3', 'f32mat3x4', 'f32mat4', 'f32mat4x2', 'f32mat4x3', 'f32mat4x4', 'f32quat', 'f32vec1', 'f32vec2', 'f32vec3', 'f32vec4', 'f64mat2', 'f64mat2x2', 'f64mat2x3', 'f64mat2x4', 'f64mat3', 'f64mat3x2', 'f64mat3x3', 'f64mat3x4', 'f64mat4', 'f64mat4x2', 'f64mat4x3', 'f64mat4x4', 'f64quat', 'f64vec1', 'f64vec2', 'f64vec3', 'f64vec4', 'float32', 'float64', 'floatBitsToInt', 'floatBitsToUint', 'float_', 'floor', 'fma', 'fmat2', 'fmat2x2', 'fmat2x3', 'fmat2x4', 'fmat3', 'fmat3x2', 'fmat3x3', 'fmat3x4', 'fmat4', 'fmat4x2', 'fmat4x3', 'fmat4x4', 'fmax', 'fmin', 'fquat', 'fract', 'frexp', 'fvec1', 'fvec2', 'fvec3', 'fvec4', 'i16vec1', 'i16vec2', 'i16vec3', 'i16vec4', 'i32mat2', 'i32mat2x2', 'i32mat2x3', 'i32mat2x4', 'i32mat3', 'i32mat3x2', 'i32mat3x3', 'i32mat3x4', 'i32mat4', 'i32mat4x2', 'i32mat4x3', 'i32mat4x4', 'i32vec1', 'i32vec2', 'i32vec3', 'i32vec4', 'i64vec1', 'i64vec2', 'i64vec3', 'i64vec4', 'i8vec1', 'i8vec2', 'i8vec3', 'i8vec4', 'imat2', 'imat2x2', 'imat2x3', 'imat2x4', 'imat3', 'imat3x2', 'imat3x3', 'imat3x4', 'imat4', 'imat4x2', 'imat4x3', 'imat4x4', 'imvec2', 'imvec3', 'imvec4', 'int16', 'int32', 'int64', 'int8', 'intBitsToFloat', 'isinf', 'isnan', 'ivec1', 'ivec2', 'ivec3', 'ivec4', 'ldexp', 'mat2', 'mat2x2', 'mat2x3', 'mat2x4', 'mat3', 'mat3x2', 'mat3x3', 'mat3x4', 'mat4', 'mat4x2', 'mat4x3', 'mat4x4', 'max', 'min', 'mix', 'modf', 'mvec2', 'mvec3', 'mvec4', 'quat', 'round', 'roundEven', 'sign', 'smoothstep', 'step', 'trunc', 'u16vec1', 'u16vec2', 'u16vec3', 'u16vec4', 'u32mat2', 'u32mat2x2', 'u32mat2x3', 'u32mat2x4', 'u32mat3', 'u32mat3x2', 'u32mat3x3', 'u32mat3x4', 'u32mat4', 'u32mat4x2', 'u32mat4x3', 'u32mat4x4', 'u32vec1', 'u32vec2', 'u32vec3', 'u32vec4', 'u64vec1', 'u64vec2', 'u64vec3', 'u64vec4', 'u8vec1', 'u8vec2', 'u8vec3', 'u8vec4', 'uint16', 'uint32', 'uint64', 'uint8', 'uintBitsToFloat', 'umat2', 'umat2x2', 'umat2x3', 'umat2x4', 'umat3', 'umat3x2', 'umat3x3', 'umat3x4', 'umat4', 'umat4x2', 'umat4x3', 'umat4x4', 'umvec2', 'umvec3', 'umvec4', 'uvec1', 'uvec2', 'uvec3', 'uvec4', 'vec1', 'vec2', 'vec3', 'vec4']
